...
const db = { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Schedule }
...
export { Restaurant, Order, Product, ProductCategory, RestaurantCategory, User, Schedule, sequelizeSession }
